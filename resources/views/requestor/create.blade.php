                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sex" value="{{ old('sex') }}" style="width: 100%;">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="civil_status" value="{{ old('civil_status') }}"  style="width: 100%;">
                                  <option value="" >--Select--</option>
                        ...
                        <div class="row">
                          <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="requestor_type" value="{{ old('requestor_type') }}" data-placeholder="Select from options below" style="width: 100%;">
                                <option value="" >--Select--</option>
                        ...
                        <div class="row">            
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="last_sem_attended" value="{{ old('last_sem_attended') }}"  style="width: 100%;">
                                  <option value="" >--Select--</option>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input  type="text/javascript" class="form-control" id="yearRange" name="last_AY_attended" value="{{ old('last_AY_attended') }}">
